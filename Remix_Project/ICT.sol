 ...
 * ICT
 *
 * Abstract contract that create Idea Campus Token based on ERC20.
 *
 */
contract ICT {
    ...
    function ICT( uint256 initialSupply, uint8 decimalUnits) public {
        balanceOf[msg.sender] = initialSupply; // Give the creator all initial tokens
        totalSupply = initialSupply; // Update total supply
        name = "IdeaCampusToken";   // Set the name for display purposes
        symbol = "ICT";    // Set the symbol for display purposes
