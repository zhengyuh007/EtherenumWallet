 ...
 * This version can contain trigger inside contract
 * user send Ether to contract, the payble function will be fallback
 * then send back Token to user according to buyPrice the owner set
 */
...
contract AAAToken {
    ...
    function AAAToken( uint256 initialSupply, uint8 decimalUnits) public {
        ...
        name = "AAAToken";   // Set the name for display purposes
    ...
    A wants to use approve and call to transfer 50 MTK to B
